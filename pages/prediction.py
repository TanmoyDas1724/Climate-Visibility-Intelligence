...
def show():
    ...
    with left_col:
        ...
        # Show prediction image (only after prediction)
        if st.session_state.prediction is not None:

            prediction = st.session_state.prediction

            if prediction >= 10:
                image_path = "assets/good_visibility.png"

            elif prediction >= 5:
                image_path = "assets/moderate_visibility.png"

            else:
                image_path = "assets/bad_visibility.png"
        ...
        with st.form("prediction_form"):
            ...
            if predict_button:
                ...
                # Immediately refresh the page so the image appears
                st.rerun()
